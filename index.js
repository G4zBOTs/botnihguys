...
const instagramlu = 'https://instagram.com/bagazzzsss'; // Nama Instagramlu cok
const whatsapplu = '0819-3878-1378'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/C4aCzhBvcOVBTMTVPj61QI'; // OFFICIAL GRUP LU 1
//
const
{
   WAConnection,
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @bagazzzsss`)
})
